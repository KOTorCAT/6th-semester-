...
** Полная таблица с подробными трактовками:** [1stage.md](1stage.md)
...
** Подробная схема и разбор:** [2stage.md](2stage.md)
...
** Более подробное описание примеров:** [2stage.md](2stage.md)
...
** Полный код проекта и документация:** [3stage/README.md](3stage/README.md)
...
### 4.6. Возникшие сложности

| Сложность | Решение |
|-----------|---------|
| Порт 8000 занят | Запуск на порту 8001 |
| Шаблоны не находились | Переместил в `notes/templates/notes/` |
| Ошибка при миграциях | Добавил `'notes'` в `INSTALLED_APPS` |
